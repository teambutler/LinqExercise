...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var persons in overTwentySix)
            {
                Console.WriteLine($"Full Name: {persons.FullName} Age: {persons.Age}");
            }
            ...
            employees = employees.Append(new Employee("First Name", "Last Name", 40, 15)).ToList();
